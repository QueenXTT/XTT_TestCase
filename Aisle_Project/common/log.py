...
class Log:
    ...
    def __init__(self):
        ...
        log_path = os.path.join(os.path.dirname(cur_path), 'logs')  # 日志文件存放路径
        ...
        self.formatter_ = logging.Formatter('[%(asctime)s] - %(levelname)s: %(message)s')  # 设置日志输出格式
        # self.pyname = pyname+msg
